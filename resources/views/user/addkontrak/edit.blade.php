<x-app title="addk | Edit">
    <div class="card-header py-2">
        <h5 class="m-0 font-weight-bold text-dark" style="text-align:center; font-size: 25px"> EDIT DAFTAR JADWAL ADDEDUM
            KONTRAK
        </h5>
    </div>
    <br>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ url('user/addk/' . $addk->id) }}" method="post">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="time" id="jam_pengajuan" name="jam_pengajuan" class="form-control"
                                value="{{ $addk->jam_pengajuan }}" list="jamList">
                            <datalist id="jamList">
                                @for ($i = 7; $i <= 17; $i++)
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="time" id="jam_selesai" name="jam_selesai" class="form-control"
                                value="{{ $addk->jam_selesai }}" list="jamList">
                            <datalist id="jamList">
                                @for ($i = 7; $i <= 17; $i++)
                                    <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}:00"></option>
                                @endfor
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="tanggal_pengajuan" class="form-control" id="tanggal_pengajuan"
                                value="{{ old('tanggal_pengajuan', $addk->tanggal_pengajuan) }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            <label for="jenis_pengajuan" class="control-label">Konsultasi addk</label>
                            <p class="form-control">{{ $addk->jenis_pengajuan }}</p>
                            <input type="hidden" name="jenis_pengajuan" value="{{ $addk->jenis_pengajuan }}">
                        </div>
                            ...
                            <select id="id_pegawai" name="id_pegawai" class="form-control">
                                ...
                                @foreach ($pegawais as $pegawai)
                                    <option value="{{ $pegawai->id }}"
                                        {{ $addk->id_pegawai == $pegawai->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="status_pegawai" name="status_pegawai" class="form-control"
                                value="{{ $addk->pegawai ? $addk->pegawai->status : '' }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="jabatan" name="jabatan" class="form-control"
                                value="{{ $addk->pegawai ? $addk->pegawai->jabatan : '' }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="nomor_hp" name="nomor_hp" class="form-control"
                                value="{{ $addk->pegawai ? $addk->pegawai->nomor_hp : '' }}" readonly>
                        </div>
                    </div>
                </div>
