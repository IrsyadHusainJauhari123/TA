<x-app title="Pengajuan Baru Konsul Jadwal | addk">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ url('user/addk') }}" method="post">
                @csrf
                    ...
                    <div class="col-md-3">
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <p class="form-control">Konsultasi addk</p>
                                <input type="hidden" name="jenis_pengajuan" value="Konsultasi addk">
                            </div>
                        @endif
                    </div>
                ...
                <!---Meni form relasi pegawai dan addk-->
                <div class="row">
                    <div class="col-md-3">
                        @if (Auth::check())
                                ...
                                <select id="id_pegawai" name="id_pegawai" class="form-control">
                                    ...
                                    @foreach ($pegawais as $pegawai)
                                        <option value="{{ $pegawai->id }}"
                                            {{ isset($addk) && $addk->id_pegawai == $pegawai->id ? 'selected' : '' }}>
                        ...
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <input type="text" id="status_pegawai" name="status_pegawai" class="form-control"
                                    value="{{ isset($addk) && $addk->pegawai ? $addk->pegawai->status : '' }}"
                                    readonly>
                            </div>
                        @endif
                    </div>
                        ...
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <input type="text" id="jabatan" name="jabatan" class="form-control"
                                    value="{{ isset($addk) && $addk->pegawai ? $addk->pegawai->jabatan : '' }}"
                                    readonly>
                            </div>
                        @endif
                    </div>
                        ...
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <input type="text" id="nomor_hp" name="nomor_hp" class="form-control"
                                    value="{{ isset($addk) && $addk->pegawai ? $addk->pegawai->nomor_hp : '' }}"
                                    readonly>
                            </div>
                        @endif
                    </div>
                </div>
                <!--end Menu form relasi Pegawai dan addk-->

                <!-- form relasi User dan addk-->
                <hr>
