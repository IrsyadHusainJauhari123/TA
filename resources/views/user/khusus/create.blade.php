...
<x-app title="Pengajuan Baru Konsul Jadwal | khusus">
    <div class="card-header py-2">
        <h5 class="m-0 font-weight-bold text-dark" style="text-align:center; font-size: 25px"> TAMBAH DAFTAR JADWAL
            khusus
        </h5>
    </div>
    <br>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ url('user/khusus') }}" method="post">
                @csrf
                    ...
                    <div class="col-md-3">
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <p class="form-control">Konsultasi khusus</p>
                                <input type="hidden" name="jenis_pengajuan" value="Konsultasi KHUSUS">
                            </div>
                        @endif
                    </div>
                ...
                <!---Meni form relasi pegawai dan khusus-->
                <div class="row">
                    <div class="col-md-3">
                        @if (Auth::check())
                                ...
                                <select id="id_pegawai" name="id_pegawai" class="form-control">
                                    ...
                                    @foreach ($pegawais as $pegawai)
                                        <option value="{{ $pegawai->id }}"
                                            {{ isset($khusus) && $khusus->id_pegawai == $pegawai->id ? 'selected' : '' }}>
                        ...
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <input type="text" id="status_pegawai" name="status_pegawai" class="form-control"
                                    value="{{ isset($khusus) && $khusus->pegawai ? $khusus->pegawai->status : '' }}"
                                    readonly>
                            </div>
                        @endif
                    </div>
                        ...
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <input type="text" id="jabatan" name="jabatan" class="form-control"
                                    value="{{ isset($khusus) && $khusus->pegawai ? $khusus->pegawai->jabatan : '' }}"
                                    readonly>
                            </div>
                        @endif
                    </div>
                        ...
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <input type="text" id="nomor_hp" name="nomor_hp" class="form-control"
                                    value="{{ isset($khusus) && $khusus->pegawai ? $khusus->pegawai->nomor_hp : '' }}"
                                    readonly>
                            </div>
                        @endif
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            @endif
                            <textarea id="alasan_pengajuan" name="alasan_pengajuan" class="form-control"></textarea>
                        </div>
                    </div>
                </div>

                <!--end Menu form relasi Pegawai dan khusus-->

                <!-- form relasi User dan khusus-->
                <hr>
