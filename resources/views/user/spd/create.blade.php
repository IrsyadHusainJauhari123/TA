<x-app title="Pengajuan Baru Konsul Jadwal | SPD">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ url('user/spd') }}" method="post">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        @if (Auth::check())
                            <div class="form-group">
                                <label for="jenis_pengajuan" class="control-label">Konsultasi spd</label>
                                <p class="form-control">Konsultasi spd</p>
                                <input type="hidden" name="jenis_pengajuan" value="Konsultasi spd">
                            </div>
                    </div>
                    @endif
                ...
                <!---Meni form relasi pegawai dan spd-->
                <div class="row">
                    <div class="col-md-3">
                        @if (Auth::check())
                                ...
                                <select id="id_pegawai" name="id_pegawai" class="form-control">
                                    ...
                                    @foreach ($pegawais as $pegawai)
                                        <option value="{{ $pegawai->id }}"
                                            {{ isset($spd) && $spd->id_pegawai == $pegawai->id ? 'selected' : '' }}>
                        ...
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <input type="text" id="status_pegawai" name="status_pegawai" class="form-control"
                                    value="{{ isset($spd) && $spd->pegawai ? $spd->pegawai->status : '' }}" readonly>
                            </div>
                        @endif
                    </div>
                    <div class="col-md-3">
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <input type="text" id="jabatan" name="jabatan" class="form-control"
                                    value="{{ isset($spd) && $spd->pegawai ? $spd->pegawai->jabatan : '' }}" readonly>
                            </div>
                        @endif
                    </div>
                    <div class="col-md-3">
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <input type="text" id="nomor_hp" name="nomor_hp" class="form-control"
                                    value="{{ isset($spd) && $spd->pegawai ? $spd->pegawai->nomor_hp : '' }}"
                                    readonly>
                            </div>
                        @endif
                    </div>
                </div>
                <!--end Menu form relasi Pegawai dan spd-->

                <!-- form relasi User dan spd-->
                <hr>
