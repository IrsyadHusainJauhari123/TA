<x-app title="Pengajuan Baru Konsul Jadwal | sp2d">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ url('user/sp2d') }}" method="post">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        @if (Auth::check())
                            <div class="form-group">
                                <label for="jenis_pengajuan" class="control-label">Konsultasi sp2d</label>
                                <p class="form-control">Konsultasi sp2d</p>
                                <input type="hidden" name="jenis_pengajuan" value="Konsultasi sp2d">
                            </div>
                        @endif
                    </div>
                ...
                <!---Meni form relasi pegawai dan sp2d-->
                <div class="row">
                    <div class="col-md-3">
                        @if (Auth::check())
                                ...
                                <select id="id_pegawai" name="id_pegawai" class="form-control">
                                    ...
                                    @foreach ($pegawais as $pegawai)
                                        <option value="{{ $pegawai->id }}"
                                            {{ isset($sp2d) && $sp2d->id_pegawai == $pegawai->id ? 'selected' : '' }}>
                        ...
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <input type="text" id="status_pegawai" name="status_pegawai" class="form-control"
                                    value="{{ isset($sp2d) && $sp2d->pegawai ? $sp2d->pegawai->status : '' }}"
                                    readonly>
                            </div>
                        @endif
                    </div>
                        ...
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <input type="text" id="jabatan" name="jabatan" class="form-control"
                                    value="{{ isset($sp2d) && $sp2d->pegawai ? $sp2d->pegawai->jabatan : '' }}"
                                    readonly>
                            </div>
                        @endif
                    </div>
                        ...
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <input type="text" id="nomor_hp" name="nomor_hp" class="form-control"
                                    value="{{ isset($sp2d) && $sp2d->pegawai ? $sp2d->pegawai->nomor_hp : '' }}"
                                    readonly>
                            </div>
                        @endif
                    </div>
                </div>
                <!--end Menu form relasi Pegawai dan sp2d-->

                <!-- form relasi User dan sp2d-->
                <hr>
