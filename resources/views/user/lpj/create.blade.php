<x-app title="Pengajuan Baru Konsul Jadwal | LPJ">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ url('user/lpj') }}" method="post">
                @csrf
                    ...
                    @if (Auth::check())
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <p class="form-control">Konsultasi LPJ</p>
                                <input type="hidden" name="jenis_pengajuan" value="Konsultasi LPJ">
                            </div>
                        </div>
                    @endif
                ...
                <!---Meni form relasi pegawai dan Lpj-->
                <div class="row">
                    <div class="col-md-3">
                        @if (Auth::check())
                                ...
                                <select id="id_pegawai" name="id_pegawai" class="form-control">
                                    ...
                                    @foreach ($pegawais as $pegawai)
                                        <option value="{{ $pegawai->id }}"
                                            {{ isset($lpj) && $lpj->id_pegawai == $pegawai->id ? 'selected' : '' }}>
                        ...
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <input type="text" id="status_pegawai" name="status_pegawai" class="form-control"
                                    value="{{ isset($lpj) && $lpj->pegawai ? $lpj->pegawai->status : '' }}" readonly>
                            </div>
                        @endif
                    </div>
                    <div class="col-md-3">
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <input type="text" id="jabatan" name="jabatan" class="form-control"
                                    value="{{ isset($lpj) && $lpj->pegawai ? $lpj->pegawai->jabatan : '' }}" readonly>
                            </div>
                        @endif
                    </div>
                    <div class="col-md-3">
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <input type="text" id="nomor_hp" name="nomor_hp" class="form-control"
                                    value="{{ isset($lpj) && $lpj->pegawai ? $lpj->pegawai->nomor_hp : '' }}"
                                    readonly>
                            </div>
                        @endif
                    </div>
                </div>
                <!--end Menu form relasi Pegawai dan LPj-->

                <!-- form relasi User dan LPj-->
                <hr>
