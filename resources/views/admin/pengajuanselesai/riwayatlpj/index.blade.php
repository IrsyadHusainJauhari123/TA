<x-app title="Pengajuan LPJ">
    <div class="card-header py-2">
        <h5 class="m-0 font-weight-bold text-dark" style="text-align:center; font-size: 25px"> RIWAYAT PENGAJUAN JADWAL
            KONSULTASI SATKER
                    ...
                    <tbody>
                        @foreach ($lpjDiterima ?? [] as $lpj)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <x-template.button.info-button url="admin/pengajuanselesai/riwayatlpj"
                                            id="{{ $lpj->id }}" />
                                        <x-template.button.delete-button url="admin/pengajuanselesai/riwayatlpj"
                                            id="{{ $lpj->id }}" />
                                    </div>
                                </td>
