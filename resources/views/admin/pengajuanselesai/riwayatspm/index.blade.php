<x-app title="Riwayat Jadwal Konsultasi Surat Perintah Membayar">
                    ...
                    <tbody>
                        @foreach ($spmDiterima as $spm)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <x-template.button.info-button url="admin/pengajuanselesai/riwayatspm"
                                            id="{{ $spm->id }}" />
                                        <x-template.button.delete-button url="admin/pengajuanselesai/riwayatspm"
                                            id="{{ $spm->id }}" />
                                    </div>
                                </td>
